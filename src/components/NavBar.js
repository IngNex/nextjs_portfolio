...
return (
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between'>
        ...
        <nav className='flex items-center justify-center flex-wrap'>
            <motion.a href="" target={"_black"} whileHover={{y:-2}} whileTap={{scale:0.9}} className="w-6 mr-3">
                <TwitterIcon/></motion.a>
            <motion.a href="" target={"_black"} whileHover={{y:-2}} whileTap={{scale:0.9}} className="w-6 mx-3">
                <GithubIcon/></motion.a>
            <motion.a href="" target={"_black"} whileHover={{y:-2}} whileTap={{scale:0.9}} className="w-6 mx-3">
                <LinkedInIcon/></motion.a>
            <motion.a href="" target={"_black"} whileHover={{y:-2}} whileTap={{scale:0.9}} className="w-6 mx-3">
                <PinterestIcon/></motion.a>
            <motion.a href="" target={"_black"} whileHover={{y:-2}} whileTap={{scale:0.9}} className="w-6 ml-3">
